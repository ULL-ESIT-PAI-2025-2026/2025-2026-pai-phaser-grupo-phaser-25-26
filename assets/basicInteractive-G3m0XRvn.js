...
//#region src/game-objects-examples/basic-interactive/interactive-rectangle-class.ts
var RectangleClass;
var init_interactive_rectangle_class = __esmMin((() => {
	init_phaser_esm();
	init_colors();
...
//#endregion
//#region src/game-objects-examples/basic-interactive/main-scene.ts
var MainScene;
var init_main_scene = __esmMin((() => {
	init_phaser_esm();
	init_interactive_rectangle_class();
	...
	*/
	function startGame() {
		new __webpack_exports__Game({
			...
			width: 800,
			height: 600,
			parent: "rectangle-interactive-app",
			scene: [MainScene],
...
//# sourceMappingURL=basicInteractive-G3m0XRvn.js.map